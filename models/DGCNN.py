# This document contains mainly the relevant code for DGCNN and RigNet networks
#
# DGCNNcatLayer reference from RigNet, DGCNN getGraphFeature and knn from DGCNN official implementation, with modifications
...
def getGraphFeature(x, k=20, idx=None):
    ...
    #[batch_size, points, topk_points, channels]
...
class DGCNNCatLayer(nn.Module):
    ...
    def forward(self, x, gIdx):
        x1 = self.DLayer(x)#knn
        x2 = self.GLayer(x, gIdx)#1-neighborhood
